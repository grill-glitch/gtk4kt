# Sliders - GNOME Human Interface Guidelines

# Sliders #

![../../_images/sliders.png](https://developer.gnome.org/hig/_images/sliders.png)![../../_images/sliders-dark.png](https://developer.gnome.org/hig/_images/sliders-dark.png)
...
If the range of values does not have a fixed maximum and/or minimum, a spin button can be used instead.
...
- For cases where exact values are sometimes required, a text field or spin button that is linked to the slider’s value can be added.
