# Text Fields - GNOME Human Interface Guidelines

# Text Fields #

![../../_images/text-fields.png](https://developer.gnome.org/hig/_images/text-fields.png)![../../_images/text-fields-dark.png](https://developer.gnome.org/hig/_images/text-fields-dark.png)
...
Password fields are a special type of text field for which GNOME provides a dedicated control . This hides entered text, which can be revealed with a button, and can be used for any potentially sensitive text.
