# Menus - GNOME Human Interface Guidelines

# Menus #

![../../_images/popover-menu-list.png](https://developer.gnome.org/hig/_images/popover-menu-list.png)![../../_images/popover-menu-list-dark.png](https://developer.gnome.org/hig/_images/popover-menu-list-dark.png)
...
- Primary menus are typically placed at the end (in Western locales on the right) of the header bar. Although, there are two exceptions to this rule: If the window incorporates hierarchical navigation , the primary menu should only be visible while on the top level view. (If other views require a menu, a secondary menu can be used.) If the window has a sidebar , the primary menu should be placed above the sidebar list.
...
| Preferences | Opens the app’s preferences dialog, if it has one. |
|---|---|
| Keyboard Shortcuts | Opens the app’s keyboard shortcuts dialog, if it has one. |
| Help | Opens the app’s user documentation in the Help app. |
| About App | Opens the app’s about dialog. This item should include the app’s name, such as About Photos or About Calculator. Every primary menu should include this item. |
