# Progress Bars - GNOME Human Interface Guidelines

# Progress Bars #

![../../_images/progress-bar.png](https://developer.gnome.org/hig/_images/progress-bar.png)![../../_images/progress-bar-dark.png](https://developer.gnome.org/hig/_images/progress-bar-dark.png)

Progress bars indicate progress on a task. Unlike spinners , they typically indicate the proportion of the task that has been completed.
...
![../../_images/osd-progress-bar.png](https://developer.gnome.org/hig/_images/osd-progress-bar.png)![../../_images/osd-progress-bar-dark.png](https://developer.gnome.org/hig/_images/osd-progress-bar-dark.png)
...
See the style class documentation for details.
