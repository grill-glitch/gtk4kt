# Placeholder Pages - GNOME Human Interface Guidelines
...
![../../_images/placeholder-illustration.png](https://developer.gnome.org/hig/_images/placeholder-illustration.png)![../../_images/placeholder-illustration-dark.png](https://developer.gnome.org/hig/_images/placeholder-illustration-dark.png)![../../_images/placeholder-symbolic.png](https://developer.gnome.org/hig/_images/placeholder-symbolic.png)![../../_images/placeholder-symbolic-dark.png](https://developer.gnome.org/hig/_images/placeholder-symbolic-dark.png)
...
It can also be a good idea to include controls for relevant actions, such as adding content or starting a setup assistant. This is one place where the suggested button style can be appropriate.
