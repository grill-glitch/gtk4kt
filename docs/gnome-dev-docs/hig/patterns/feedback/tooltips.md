# Tooltips - GNOME Human Interface Guidelines
...
|---|---|
| Recently Used Documents | Open recently used documents |
| Grid View | Switch to grid view |
| Fullscreen | Show the current image in fullscreen mode |
...
|---|---|---|
| Go back | Back |  |
| Search | Search | In some cases, it can be useful to specify the content type. For example: Search Documents. |
| Primary menu | Main Menu |  |
| Secondary menu | Menu | Where possible, specify the item to which the menu applies. For example: Document Menu. |
| New tab | New Tab |  |
