# Selection & Edit Modes - GNOME Human Interface Guidelines
...
- When selection mode is active: Clicking anywhere on a content item should toggle its selection state. The header bar should show a cancel button and the heading should indicate the number of selected items. An action bar should show available actions for the selection, at the bottom of the screen.
...
- GTK 4: GtkActionBar
- Libadwaita: .selection-mode style class
