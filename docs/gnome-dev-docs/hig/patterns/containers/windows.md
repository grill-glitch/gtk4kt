# Windows - GNOME Human Interface Guidelines

# Windows #

![../../_images/application-window.png](https://developer.gnome.org/hig/_images/application-window.png)![../../_images/application-window-dark.png](https://developer.gnome.org/hig/_images/application-window-dark.png)
...
- Libadwaita: AdwApplicationWindow
- Libadwaita: AdwAboutWindow
- Libadwaita: AdwPreferencesWindow
