# Pointer & Touch - GNOME Human Interface Guidelines
...
In addition, all actions which can be accomplished with a pointing device should also be possible with a keyboard .
