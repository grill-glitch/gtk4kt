# Navigation - GNOME Human Interface Guidelines

# Navigation #

While some apps only need a single view in which to show their UI, most need to be broken down into a series of views or windows. The navigation and containers patterns cover the most common design options for doing this. This page provides some general guidance on how to put them together.
...
- observing general guidelines , such as avoiding stacking secondary windows
...
![../_images/flat.svg](https://developer.gnome.org/hig/_images/flat.svg)
...
Sidebars are another flat navigation pattern, which can be used if there are too many pages to be accommodated within a view switcher.
...
![../_images/combined.svg](https://developer.gnome.org/hig/_images/combined.svg)
