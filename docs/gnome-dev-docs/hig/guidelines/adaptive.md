# Scaling & Adaptiveness - GNOME Human Interface Guidelines
...
- Using established patterns and widgets (such as view switchers ) generally makes things easier as they are often designed with adaptiveness in mind.
...
To avoid these issues, place content within containers that have a maximum width. These can include both visible containers, like lists , or invisible containers which act as a restraining frame.
