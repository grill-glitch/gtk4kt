# Backgrounds - GNOME Human Interface Guidelines
...
![../_images/background-cropping-1920.webp](https://developer.gnome.org/hig/_images/background-cropping-1920.webp)

The following image illustrates how a range of landscape aspect ratios (32/9, 16/9, and 4/3) would be cropped to fit:

![../_images/background-cropping-landscape.webp](https://developer.gnome.org/hig/_images/background-cropping-landscape.webp)
...
![../_images/background-cropping-portrait.webp](https://developer.gnome.org/hig/_images/background-cropping-portrait.webp)
...
![../_images/lock-screen.webp](https://developer.gnome.org/hig/_images/lock-screen.webp)

Then when authenticating, a login prompt is shown:

![../_images/lock-screen-auth.webp](https://developer.gnome.org/hig/_images/lock-screen-auth.webp)
